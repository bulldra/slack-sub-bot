...
def main():
    ...
    try:
        res = client.chat_update(channel=channel, ts=ts, blocks=blocks_50_md, text="test 50 md")
    ...
    try:
        res = client.chat_update(channel=channel, ts=ts, blocks=blocks_50_sec, text="test 50 sec")
