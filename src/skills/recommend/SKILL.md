...
指示:
    prompt: |
        ...
        シグマは登場させないで。
        markdownのリンクで記事をリンクさせつつおすすめ理由や記事概要も300文字づつぐらいで教えて。
        これまでの会話と関連付けされそうであれば言及して。
        output_formatを参考にしつつも口調はランダムに変えて。
        最後に総括するようなセリフを入れて。
    output_format: |
        『[タイトル1](https://example.com/news/001)』がおすすめ。AIを活用して生産性がアップ知っているんだって。
